...
<head>
    ...
    <title>Reset password · Laravel IAM Console</title>
    <style>
        * { box-sizing: border-box; }
        ...
        input[type=email] { width:100%; padding:.6rem .75rem; background:#0b0f14; color:#e5e7eb;
        ...
        .ok { margin-top:1rem; padding:.6rem .75rem; background:#0c2b26; border:1px solid #115e59; color:#99f6e4;
               border-radius:9px; font-size:.85rem; }
        .back { display:block; margin-top:1rem; text-align:center; font-size:.82rem; color:#5ecec2; text-decoration:none; }
    </style>
</head>
<body>
    <form class="card" method="POST" action="/forgot-password">
        ...
        <div class="brand"><span class="dot"></span>
            <div><h1>Reset your password</h1><p class="sub">We'll email you a secure link to set a new password.</p></div>
        </div>
